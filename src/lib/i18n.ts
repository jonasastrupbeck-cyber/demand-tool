...
const translations = {
  ...
  'capture.demandClassificationHelp': {
    en: 'Value demand: demand the organisation exists to serve — what the customer wants or needs help with ("I need X"). Demand the organisation should be getting.\n\nFailure demand: demand caused by a failure to do something, or do something right, for the customer ("Where\'s my…?", "I called last week…"). Demand the organisation should not be getting.',
    da: 'Værdiskabende efterspørgsel: efterspørgsel som organisationen findes for at betjene — et reelt behov kunden vil have opfyldt ("jeg har brug for X"). Den efterspørgsel organisationen bør få.\n\nIkke-værdiskabende efterspørgsel: efterspørgsel forårsaget af, at noget ikke er gjort eller ikke er gjort rigtigt fra kundens perspektiv ("hvor er min…?", "jeg ringede i sidste uge…"). Den efterspørgsel organisationen ikke bør få.',
    sv: 'Värdeskapande efterfrågan: efterfrågan som tjänsten finns till för att betjäna — ett verkligt behov kunden vill få tillgodosett ("jag behöver X"). Den efterfrågan organisationen borde få.\n\nIcke-värdeskapande efterfrågan: efterfrågan orsakad av att något inte har gjorts eller inte har gjorts rätt ur kundens perspektiv ("var är min…?", "jag ringde förra veckan…"). Den efterfrågan organisationen inte borde få.',
    de: 'Wertnachfrage: Nachfrage, der die Organisation dienen soll — ein echtes Bedürfnis, das der Kunde erfüllt haben möchte ("Ich brauche X"). Nachfrage, die die Organisation bekommen soll.\n\nFehlernachfrage: Nachfrage, verursacht durch das Versäumnis, etwas für den Kunden zu tun oder es richtig zu tun ("Wo ist mein…?", "Ich habe letzte Woche angerufen…"). Nachfrage, die die Organisation nicht bekommen sollte.',
  },
