...
const translations = {
  ...
  'dashboard.synthesisTabHelp': {
    en: 'Study the captured system conditions and merge the ones that are really the same onto one agreed name.',
    da: 'Studér de opfangede systemforhold og slå dem sammen, der reelt er det samme, til ét aftalt navn.',
  ...
  'synthesis.selectHint': {
    en: 'Select the conditions that are the same or similar, then merge them.',
    da: 'Vælg de forhold, der er samme eller lignende, og slå dem derefter sammen.',
    sv: 'Välj de villkor som är samma eller liknande och slå sedan ihop dem.',
    de: 'Wählen Sie die gleichen oder ähnlichen Bedingungen und führen Sie sie dann zusammen.',
  },
  'synthesis.distributionTitle': {
    en: 'How often each condition appears',
    da: 'Hvor ofte hvert forhold optræder',
  ...
  'synthesis.mergeInto': {
    ...
    sv: 'Behåll som ett villkor',
    de: 'Als eine Bedingung behalten',
  },
