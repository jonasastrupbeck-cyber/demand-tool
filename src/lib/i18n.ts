...
const translations = {
  ...
  'settings.subquestionFormulaHelp': {
    en: 'Use + − × ÷ and the buttons to insert fields. MONTHS() turns a duration into months; MONTHS_BETWEEN() counts months between two dates.',
    da: 'Brug + − × ÷ og knapperne til at indsætte felter. MONTHS() laver en varighed om til måneder; MONTHS_BETWEEN() tæller måneder mellem to datoer.',
    sv: 'Använd + − × ÷ och knapparna för att infoga fält. MONTHS() gör en varaktighet till månader; MONTHS_BETWEEN() räknar månader mellan två datum.',
    de: 'Nutze + − × ÷ und die Schaltflächen, um Felder einzufügen. MONTHS() wandelt eine Dauer in Monate um; MONTHS_BETWEEN() zählt Monate zwischen zwei Daten.',
  },
  ...
  'settings.subquestionFormulaNoFields': {
    en: 'Add other fields to this milestone first, then reference them here.',
    da: 'Tilføj andre felter til denne milepæl først, og henvis til dem her.',
    sv: 'Lägg till andra fält i denna milstolpe först och hänvisa till dem här.',
    de: 'Füge diesem Meilenstein zuerst andere Felder hinzu und verweise dann hier darauf.',
  },
