...
import { getStudyByCode, getWorkTypeById, getLifecycleStages, getLifecycleStageByCode, setWorkTypeLifecycle } from '@/lib/queries';
...
export async function POST(
  ...
  const type = await getWorkTypeById(id);
  ...
  try {
    ...
    await setWorkTypeLifecycle(id, stageId, { aiSuggestion: stageId });
